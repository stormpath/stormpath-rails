...
RSpec.configure do |config|
  ...
  config.before(:all) do
    if ENV["STORMPATH_RAILS_TEST_API_KEY_SECRET"].blank? or ENV["STORMPATH_RAILS_TEST_API_KEY_ID"].blank? or ENV["STORMPATH_RAILS_TEST_APPLICATION_URL"].blank? or ENV["STORMPATH_RAILS_TEST_DIRECTORY_URL"].blank?
      raise "consult spec_helper for required environment variables before running specs"
    end
